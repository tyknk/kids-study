...
3年生5月時点では3年生配当漢字もほぼ未習得。問題文・グラフラベル・解説文など子どもが読むすべての箇所を対象にチェックすること。

| 漢字 | 学年 | よくある使われ方 | 対応 |
|------|------|-----------------|------|
| 好 | **4年** | 「好きな〇〇しらべ」 | `すきな` にひらがな化 |
| 差 | **4年** | 「差（ちがい）を求める」 | `ちがい（さ）` と逆転させる |
| 揚 | **配当外** | 「から揚げ」（食べ物ラベル） | `からあげ` にひらがな化 |
| 縦 | **配当外** | 「縦（たて）の列」 | `たて` にひらがな化 |
| 横 | 3年 | 「横（よこ）の行」 | `<ruby>横<rt>よこ</rt></ruby>` またはひらがな化 |
| 列 | 3年 | 「行と列」 | `<ruby>列<rt>れつ</rt></ruby>` |
| 整 | 3年 | 「整理する」 | `まとめる` に言い換え推奨 |
| 表 | 3年 | 「表したグラフ」（動詞） | `<ruby>表<rt>あらわ</rt></ruby>した` |
| 筆 | 3年 | 「筆算」（単元名） | `<ruby>筆算<rt>ひっさん</rt></ruby>` |
| 倍 | 3年 | 「何倍」（単元名） | `<ruby>倍<rt>ばい</rt></ruby>` |

> ⚠️ タイトル・サブタイトル・カードの説明文だけでなく、**問題文の文字列・グラフのラベル・データのタイトル・解説パネル**も同じルールが適用される。JSのデータ定義内に漢字が埋め込まれているケースが多いため特に注意。

#### 漢字以外の語彙難易度チェック

漢字が正しくてもことばとして難しい場合がある。以下を参考に表現を選ぶこと。

| 避ける表現 | 推奨する表現 | 理由 |
|----------|------------|------|
| 交わるところ・まじわるところ | かさなるところ | 「交わる」は感覚的に分かりにくい |
| 整理する | まとめる | 「整理」は概念として少し難しい |
| 差を求める | ちがいをもとめる | 「差」は4年漢字かつ数学用語 |
| 横の合計／縦の合計 | よこの合計／たての合計 | 横・縦は3年漢字 |
| 十分の一の位 | 0.1のくらい | 分数の知識がないと難しい |
